...
function read(){let x_0 = (() => {return readLine()})();
let y_1 = (() => {return readLine()})();
return (toInt(x_0))+(toInt(y_1))}
function doit(){let r_0 = (() => {return read()})();
let t_1 = (() => {return ((__match__) => {if(0==__match__){return println("is zero")}if(true){return println("not zero")}error("Match case not exclusive")})(r_0)
})();
error("bye")}
