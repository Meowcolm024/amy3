...
function testLitFold(){let x = (1)+((2)*(3));let y = ("hello")+(" world");println(toString((Math.floor(((x)*(233))/(2)))+(omg())));println((y)+("!"));let z = (1)+(omg());return print(toString((Math.floor((z)/(z)))+(omg())))}
