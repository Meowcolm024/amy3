...
function test(){let x = (() => {return readLine()})();let u = (() => {return "zzzzz"})();let y = (() => {return readLine()})();let z = (() => {return (x)+(" world")})();return ((_) => {let t = (() => {return (readLine())+("hahaha")})();return ((_) => {error("bye")})(println(((t)+(t))+(u)))})(println(("goodbye ")+(z)))}
